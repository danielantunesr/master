<?php
	...
	class Enderecos{
		...
		private $id, $fkcliente, $tipologradouro, $logradouro, $numero, $complemento, $cep, $cidade, $uf, $bairro;
		
		function __construct($id, $fkcliente, $tipologradouro, $logradouro, $numero, $complemento, $cep, $cidade, $uf, $bairro) {
			$this->id = $id;
		...
		{
			return 'Identificador: '. $this->getId() . '<br>' . 'Cliente: ' . $this->getFkCliente(). '<br>' . 'Tipo de Logradouro: ' . $this->getTipoLogradouro() . '<br>' .
